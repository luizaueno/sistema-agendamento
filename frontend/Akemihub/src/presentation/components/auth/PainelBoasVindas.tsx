...
function PainelBoasVindas({telaAtual, alternarTela}: PainelProps) {
    return (
        <div className="painel-boas-vindas" aria-labelledby="boas-vindas-titulo" role="region">
            ...
            {/* REMOVIDO O '&&'. Agora usamos as classes do seu CSS para controlar o visual */}
            <div className="conteudo-boas-vindas texto-cadastro-ativo">
            ...
            {/* REMOVIDO O '&&'. Ambos os blocos ficam vivos para o CSS poder animar */}
            <div className="conteudo-boas-vindas texto-login-ativo">
